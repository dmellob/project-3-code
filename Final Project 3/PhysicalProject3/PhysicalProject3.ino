...
/*
 * 
 * WHILE WE DID NOT USE THIS CODE IN OUR FINAL PROJECT, WE ATTEMPTED TO USE THIS TO ASSIST US IN OUR PROJECT IN ORDER TO GET THE MICROPHONE. 
  Physical Pixel
...
int outgoingByte;      // a variable to read incoming serial data into
